  ...
  const reverse =
    from === 'self-start' ? (
      <>
        ...
        <div
          className={` ${color} max-w-sm sm:max-w-xs md:max-w-sm lg:max-w-md sm:max-h-15 md:max-h-28 lg:max-h-40 mt-4 sm:mt-3 md:mt-3 lg:mt-3 px-3 py-3 rounded-r-lg rounded-tl-lg`}
        >
      ...
      <>
        <div
          className={` ${color} max-w-sm sm:max-w-xs md:max-w-sm lg:max-w-md max-h-28 sm:max-h-15 md:max-h-28 lg:max-h-40 mt-4 sm:mt-3 md:mt-3 lg:mt-3 px-3 py-3 rounded-l-lg rounded-tr-lg`}
        >
          <p className=" font-medium sm:text-md md:text-xl lg:text-2xl break-words">
            {text}
          </p>
